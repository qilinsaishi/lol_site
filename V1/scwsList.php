...
$data = [
    ...
    "totalPlayerList"=>["game"=>$config['game'],"page"=>1,"page_size"=>9,"source"=>$config['source'],"fields"=>'player_id,player_name,logo',"rand"=>1,"cacheWith"=>"currentPage","cache_time"=>86400*7],
  ...
  <div class="container margin120">
      <div class="row heroList">
          <div class="col-md-12">
              ...
              <li><a href="<?php echo $config['site_url']; ?><?php echo "/scws/".$ids;?>"><?php echo $return['scwsKeyword']['data']['keyword'];?></a></li>
          </ol>
    <div class="row">
